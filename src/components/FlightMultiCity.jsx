...
const FlightMultiCity = ({ adjustHeight }) => {
    ...
    return (
        ...
        >
            {({
                ...
                useEffect(() => {
                    // This hook now runs when the component mounts
                    if (values.multiCity.length === 1) {
                        setFieldValue("multiCity", [
                            ...values.multiCity,
                            ...
                            render={(arrayHelpers) => (
                                <div className="flex flex-col">
                                    ...
                                    {values.multiCity.map((input, index) => (
                                        <div key={index}
                                             className="flex lg:flex-row flex-col items-start gap-4 md:px-0 px-5 max-w-7xl">
                                            <div className={`mb-2 flex items-center space-x-2 ${index !== 0 ? "md:mt-3 mt-3":""}`}>
                                                <div>
                                                    <span>Origin</span>
                                                    {/* Autocomplete 1 */}
                                                    <Autocomplete
                                    ...
                                    <MdOutlineFlightTakeoff style={{fontSize: '24px'}}/> {/* Adjust icon size here */}
                                            ...
                                            <div
                                                ...
                                                <div
                                                    className="flex justify-center flex-col md:flex-row items-center gap-1">
                                                    <div
                                                        className={`flex justify-center flex-row ${index !== 0 ? "mt-3":"" } items-center gap-1`}>
                                                        <div className="flex flex-col">
                                                            <span>Depart</span>
                                                                ...
                                                                <LocalizationProvider dateAdapter={AdapterDayjs}>
                                                                    <DemoContainer components={['DateRangePicker']}>
                                                                        <DatePicker
                                                                            ...
                                                                            onChange={(newDate) => {
                                                                                // Format the date as 'YYYY-MM-DD' using dayjs
                                                                                const formattedDate = dayjs(newDate).format('YYYY-MM-DD');
                                                                                setFieldValue(`multiCity.${index}.date`, formattedDate);
                                                        ...
                                                        {index !== 0 && (
                                                            <button
                                                                ...
                                                                onClick={(index) =>{
                                                                    ...
                                                                    adjustHeight(values.multiCity.length - 1);
                                                                }}
                                                            >
                                                            ...
                                                            <div>
                                                                <div className="flex flex-col md:mt-0 mt-6">
                                                                    ...
                                                                    <TextField
                                                                        ...
                                                                        className="rounded-[0.3rem]"
                                                                        style={{
                                                                            width: window.innerWidth < 1200 ? '200px' : '185px',
                                                                            backgroundColor: "white",
                                                                        }}
                                                                        InputProps={{
                                                                            startAdornment: (
                                    ...
                                    <span style={{display: 'flex', alignItems: 'center', height: '40px'}}>
                                        <MdFlightLand style={{fontSize: '24px'}}/>
                                            ...
                                            <div className="md:px-0 px-4 w-full mt-6">
                                        <button
                                            className="px-2 py-2 w-36 bg-black text-white rounded hover:bg-blue-700"
                                            onClick={() => {
                                                if (values.multiCity.length < 5) { // Check before pushing
                                                    ...
                                                    adjustHeight(values.multiCity.length + 1); // Call the function to adjust height
                                                }
                                            }}
                                        >
                                            Add city
