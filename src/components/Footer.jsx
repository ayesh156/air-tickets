...
const Footer = () => {
    ...
    return (
        <footer>
            <div className="bottom-0 left-0 right-0 border-b-2 md:border-b-0 bg-[#F3F3F3] z-20">
            ...
            <div className="bg-primaryBlue text-center flex flex-col justify-center items-center py-8">
                ...
                <span className="mt-4 px-4 text-blue-100 w-full text-[14px]">Travel Gate International (Pvt) Ltd | Designed & Developed by Silicon Radon Networks (Pvt) Ltd.</span>
            </div>
        </footer>
